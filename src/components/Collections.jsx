...
function Collections() {
  ...
  const collections = [
    ...
    },
    {
      id: 3,
      name: "Sports Watches",
      image: "https://images.unsplash.com/photo-1594576662435-76b1d0f48c1e?w=600&h=400&fit=crop&auto=format",
      ...
      <div className="container">
        <div className="collections-header">
          ...
          <p className="coll-subtitle">
            Discover our carefully curated selection of timepieces for every style and occasion
          </p>
        </div>
